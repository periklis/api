...
logPipelineStageExpr:
        ...
        |       PIPE IDENTIFIER comparisonOp IP OPEN_PARENTHESIS STRING CLOSE_PARENTHESIS { $$ = newLogPipelineStageExpr("", nil, LogFiltersExpr{newLogFilterExpr("|", $2, $3, "ip", $6)}) }
                ;
...
logFormatExpr:
        ...
        |       IDENTIFIER EQ IP OPEN_PARENTHESIS STRING CLOSE_PARENTHESIS { $$ = newLogFormatExpr("", LogFormatValues{$1: newLogFormatValue("ip("+$5+")", false)}) }
